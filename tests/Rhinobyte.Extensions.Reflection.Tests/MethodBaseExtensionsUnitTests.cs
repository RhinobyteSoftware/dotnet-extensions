...
(11) RETURN");
		...
		public void GetSignature_returns_the_expected_result_basic()
		{
			...
			methodToTest!.GetSignature(true).Should().Be("public static int Rhinobyte.Extensions.Reflection.UnitTests.Setup.ExampleMethods.AddLocalVariables_For_5_And_15()");
		}
		...
		public void GetSignature_returns_the_expected_result_with_generics1()
		{
			...
			genericMethodToTest1!.GetSignature(true).Should().Be("public T? Rhinobyte.Extensions.Reflection.UnitTests.Setup.GenericStruct<T>.TryGetSomething() where T : System.IConvertible, struct");
		}
		...
		public void GetSignature_returns_the_expected_result_with_generics2()
		{
			...
			genericMethodToTest!.GetSignature(true).Should().Be("public static Rhinobyte.Extensions.Reflection.UnitTests.Setup.ExampleGenericType<System.Reflection.Emit.OperandType, string, System.Reflection.Emit.OpCodeType>? Rhinobyte.Extensions.Reflection.UnitTests.Setup.ExampleGenericType<System.Reflection.Emit.OperandType, string, System.Reflection.Emit.OpCodeType>.TryCreate(System.Reflection.Emit.OperandType property1, string? property2, System.Reflection.Emit.OpCodeType property3)");
		}
		...
		public void GetSignature_returns_the_expected_result_with_generics3()
		{
			...
			genericMethodToTest!.GetSignature(true).Should().Be("public virtual async System.Threading.Tasks.Task<Rhinobyte.Extensions.Reflection.UnitTests.Setup.ExampleGenericType<System.Reflection.Emit.OperandType, string, System.Reflection.Emit.OpCodeType>?> Rhinobyte.Extensions.Reflection.UnitTests.Setup.ExampleGenericType<System.Reflection.Emit.OperandType, string, System.Reflection.Emit.OpCodeType>.SomeInstanceMethodAsync(System.Reflection.Emit.OperandType property1, string? property2, System.Reflection.Emit.OpCodeType property3)");
		}
		...
		public void GetSignature_returns_the_expected_result_with_generics4()
		{
			...
			genericMethodToTest!.GetSignature(true).Should().Be("public static Rhinobyte.Extensions.Reflection.UnitTests.Setup.ClosedGenericType? Rhinobyte.Extensions.Reflection.UnitTests.Setup.ClosedGenericType.TryCreate(System.DateTimeKind property1, string property2, System.DateTime property3)");
		}
		...
		public void GetSignature_returns_the_expected_result_with_generics5()
		{
			...
			genericMethodToTest!.GetSignature(true).Should().Be("public virtual async System.Threading.Tasks.Task<Rhinobyte.Extensions.Reflection.UnitTests.Setup.ExampleGenericType<System.DateTimeKind, string, System.DateTime>?> Rhinobyte.Extensions.Reflection.UnitTests.Setup.ExampleGenericType<System.DateTimeKind, string, System.DateTime>.SomeInstanceMethodAsync(System.DateTimeKind property1, string? property2, System.DateTime property3)");
		}
