...
{
	public interface IExplicitConstructorFactory
	{
		Func<IServiceProvider, object> Factory { get; }
	}

	public class ExplicitConstructorFactory<TImplementationType> : IExplicitConstructorFactory
		where TImplementationType : class
	{
		...
		public Func<IServiceProvider, object> Factory => CallConstructor;
