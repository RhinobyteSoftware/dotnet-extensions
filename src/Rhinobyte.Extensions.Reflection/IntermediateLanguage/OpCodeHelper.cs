...
public static class OpCodeHelper
{
	...
	/// </summary>
	public static readonly IReadOnlyCollection<OpCode> InternalOpcodes = [OpCodes.Prefix7, OpCodes.Prefix6, OpCodes.Prefix5, OpCodes.Prefix4, OpCodes.Prefix3, OpCodes.Prefix2, OpCodes.Prefix1, OpCodes.Prefixref];

	/// <summary>
	/// Collection of the <see cref="OpCode"/> numeric values that are used in a <see cref="LocalVariableInstruction"/> 
	/// </summary>
	public static readonly IReadOnlyCollection<short> LocalVariableOpcodeValues = [17, 18, 19, -500, -499, -498];
