...
public class AssemblyScanResult : IAssemblyScanResult
{
	...
	/// </summary>
	public HashSet<Type> AllDiscoveredTypes { get; } = [];
	...
	/// </summary>
	public HashSet<AssemblyInclude> IgnoredAssemblies { get; } = [];
	...
	/// </summary>
	public HashSet<Type> InterfaceTypes { get; } = [];
	...
	/// </summary>
	public HashSet<Type> OpenGenericTypes { get; } = [];
	...
	/// </summary>
	public HashSet<AssemblyInclude> ScannedAssemblies { get; } = [];
